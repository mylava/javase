package cn.mylava._300._1_Grammar._013_Operator;
...
public class TestOperator {
    public static void main(String[] args) {
        ...
        int m = 10;
        int n = 4;
        // int类型的变量占4个字节  8的二进制表示形式位 0000_0000_00000000_00000000_0000_1000   其中第一位的表示符号,1为负,0为正
        System.out.println("按位取反---------\t\t\t\t" + (~m));
        System.out.println("按位与---------" + (m & n));
        System.out.println("按位或---------" + (m | n));
        System.out.println("按位异或---------" + (m ^ n));//异或的计算规则为   00或11得0   10或01得1    就是相异得1
