...
public class Pfx2Jks {
    ...
    public static final String PFX_KEYSTORE_FILE = "/Users/lipengfei/Desktop/test_client_16.pfx";// pfx文件位置
    public static final String PFX_PASSWORD = "Abcd1234";// 导出为pfx文件的设的密码
    public static final String JKS_KEYSTORE_FILE = "/Users/lipengfei/Desktop/test_client_16.jks"; // jks文件位置
    public static final String JKS_PASSWORD = "Abcd1234";// JKS的密码
